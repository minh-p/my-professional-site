...
#+hugo_base_dir: ../
* DONE Let's Focus on C++
CLOSED: [2025-12-18 Thu 10:22]
:PROPERTIES:
:EXPORT_FILE_NAME: Let's Focus on C++
:EXPORT_OPTIONS: toc:nil
:ID:       e1b25881-31a9-4c69-8ca5-d6c25a3b56af
:END:
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-12-18 Thu 10:22]
:END:
...
** C++ Resources - [[https://github.com/m3y54m/Embedded-Engineering-Roadmap?tab=readme-ov-file#-c-1][C++ Embedded Engineering Roadmap]]
...
- [[https://create.roblox.com/docs/reference/engine/classes/Terrain][Roblox Terrain API]] - Instead of generating terrain with parts, I'll be using Roblox terrain tool to generate procedural geography.

...
erDiagram
  ...
  GRID {
    string gridId PK
    string worldId FK
    int gx        "grid X coordinate"
    int gy        "grid Y coordinate"
    int size      "world units covered"
    string placeId
    string jobId  "active server (optional)"
    int softCapPlayers
